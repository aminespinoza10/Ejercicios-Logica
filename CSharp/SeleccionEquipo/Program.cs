...
namespace SeleccionEquipo
{
    class Program
    {
        private static Dictionary<int, string> teamList = new Dictionary<int, string>();
        ...
        private static string DeleteMissingPeople()
        {
        ...
        private static void PresentRemainingPeople(string membersToDelete)
        {
        ...
        private static void SuggestNextMember()
        {
        ...
        private static void DeleteSingleMember(int memberKey)
        {
